  ...
  const [cartItems, setCartItems] = useState([
    {
      ...
      description: 'Espresso with vanilla syrup, milk and caramel sauce',
      price: '$5.99',
  ...
  return (
    <View style={tw`flex-1 bg-amber-50`}>
      ...
      <ScrollView style={tw`flex-1 px-6`} showsVerticalScrollIndicator={false}>
        ...
        {/* Delivery Info */}
        <View style={tw`bg-white rounded-2xl shadow-sm border border-amber-200 p-6 mb-6`}>
          <Text style={tw`text-xl font-bold text-amber-900 mb-4`}>Delivery Information</Text>
          
          <View style={tw`flex-row items-center mb-3`}>
            <Icon name="location-on" size={20} color="#6F4E37" />
            <Text style={tw`text-amber-900 font-medium ml-2`}>Delivery to: Home</Text>
          ...
          <View style={tw`flex-row items-center`}>
            <Icon name="schedule" size={20} color="#6F4E37" />
            <Text style={tw`text-amber-900 font-medium ml-2`}>Delivery in 25-35 min</Text>
          </View>
        </View>
      </ScrollView>
